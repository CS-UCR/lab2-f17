...
80106c96:	c7 44 24 04 f3 78 10 	movl   $0x801078f3,0x4(%esp)
80106c9d:	80 
...
80106cf5:	53                   	push   %ebx
  ...
  int i = 0;
  int emptyIndex = -1;
80106cf6:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
int shm_open(int id, char **pointer) {
...
80106d14:	eb 16                	jmp    80106d2c <shm_open+0x3c>
80106d16:	66 90                	xchg   %ax,%ax
80106d18:	85 c9                	test   %ecx,%ecx
80106d1a:	0f 44 d8             	cmove  %eax,%ebx
  for(; i<64; i++)
80106d1d:	83 c0 01             	add    $0x1,%eax
80106d20:	83 c2 0c             	add    $0xc,%edx
80106d23:	83 f8 40             	cmp    $0x40,%eax
80106d26:	0f 84 84 00 00 00    	je     80106db0 <shm_open+0xc0>
  {
    if(shm_table.shm_pages[i].id == id)
80106d2c:	8b 0a                	mov    (%edx),%ecx
80106d2e:	39 f1                	cmp    %esi,%ecx
80106d30:	75 e6                	jne    80106d18 <shm_open+0x28>
    {
      found = 1;
      if(mappages(myproc()->pgdir, (char*)myproc()->sz, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U) < 0)
80106d32:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106d35:	c1 e3 02             	shl    $0x2,%ebx
80106d38:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d3e:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
80106d44:	e8 67 c9 ff ff       	call   801036b0 <myproc>
80106d49:	8b 38                	mov    (%eax),%edi
80106d4b:	e8 60 c9 ff ff       	call   801036b0 <myproc>
80106d50:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d57:	00 
80106d58:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106d5c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d63:	00 
80106d64:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106d68:	8b 40 04             	mov    0x4(%eax),%eax
80106d6b:	89 04 24             	mov    %eax,(%esp)
80106d6e:	e8 dd f7 ff ff       	call   80106550 <mappages>
80106d73:	85 c0                	test   %eax,%eax
80106d75:	0f 88 d5 00 00 00    	js     80106e50 <shm_open+0x160>
      {
        cprintf("mapping segment id to an available page failed\n");
      } else {
        shm_table.shm_pages[i].refcnt++;
80106d7b:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
    {
...
80106d82:	e8 29 c9 ff ff       	call   801036b0 <myproc>
80106d87:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106d8a:	8b 00                	mov    (%eax),%eax
80106d8c:	89 07                	mov    %eax,(%edi)
      myproc()->sz += PGSIZE;
80106d8e:	e8 1d c9 ff ff       	call   801036b0 <myproc>
80106d93:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
    }
  }
  release(&(shm_table.lock));
80106d99:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106da0:	e8 9b d4 ff ff       	call   80104240 <release>
  bad:
  return 0; 
}
80106da5:	83 c4 2c             	add    $0x2c,%esp
...
80106db0:	8d 3c 5b             	lea    (%ebx,%ebx,2),%edi
80106db3:	c1 e7 02             	shl    $0x2,%edi
80106db6:	89 b7 f4 54 11 80    	mov    %esi,-0x7feeab0c(%edi)
    mem = kalloc();
...
80106dc3:	89 c3                	mov    %eax,%ebx
    if(!mem)
80106dc5:	0f 84 96 00 00 00    	je     80106e61 <shm_open+0x171>
    memset(mem, 0, PGSIZE);
80106dcb:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dd2:	00 
80106dd3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106dda:	00 
80106ddb:	89 1c 24             	mov    %ebx,(%esp)
80106dde:	e8 ad d4 ff ff       	call   80104290 <memset>
    shm_table.shm_pages[emptyIndex].frame = mem;
80106de3:	89 9f f8 54 11 80    	mov    %ebx,-0x7feeab08(%edi)
    shm_table.shm_pages[emptyIndex].refcnt = 1;
80106de9:	c7 87 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%edi)
80106df0:	00 00 00 
    if(mappages(myproc()->pgdir, (char*)myproc()->sz, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0)
80106df3:	e8 b8 c8 ff ff       	call   801036b0 <myproc>
80106df8:	8b 30                	mov    (%eax),%esi
80106dfa:	e8 b1 c8 ff ff       	call   801036b0 <myproc>
80106dff:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
80106e05:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e0c:	00 
80106e0d:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106e11:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e18:	00 
80106e19:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e1d:	8b 40 04             	mov    0x4(%eax),%eax
80106e20:	89 04 24             	mov    %eax,(%esp)
80106e23:	e8 28 f7 ff ff       	call   80106550 <mappages>
80106e28:	85 c0                	test   %eax,%eax
80106e2a:	0f 89 52 ff ff ff    	jns    80106d82 <shm_open+0x92>
      cprintf("Out of memory\n");
80106e30:	c7 04 24 fc 78 10 80 	movl   $0x801078fc,(%esp)
80106e37:	e8 14 98 ff ff       	call   80100650 <cprintf>
      kfree(mem);
80106e3c:	89 1c 24             	mov    %ebx,(%esp)
80106e3f:	e8 bc b4 ff ff       	call   80102300 <kfree>
80106e44:	e9 50 ff ff ff       	jmp    80106d99 <shm_open+0xa9>
80106e49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        cprintf("mapping segment id to an available page failed\n");
80106e50:	c7 04 24 0c 79 10 80 	movl   $0x8010790c,(%esp)
80106e57:	e8 f4 97 ff ff       	call   80100650 <cprintf>
80106e5c:	e9 38 ff ff ff       	jmp    80106d99 <shm_open+0xa9>
      cprintf("Out of memory\n");
80106e61:	c7 04 24 fc 78 10 80 	movl   $0x801078fc,(%esp)
80106e68:	e8 e3 97 ff ff       	call   80100650 <cprintf>
      goto bad;
80106e6d:	e9 33 ff ff ff       	jmp    80106da5 <shm_open+0xb5>
...
80106ea9:	74 31                	je     80106edc <shm_close+0x5c>
  {
    if(shm_table.shm_pages[i].id == id)
...
80106ead:	75 f1                	jne    80106ea0 <shm_close+0x20>
    {
      shm_table.shm_pages[i].refcnt--;
80106eaf:	8d 04 40             	lea    (%eax,%eax,2),%eax
80106eb2:	c1 e0 02             	shl    $0x2,%eax
80106eb5:	8b 98 fc 54 11 80    	mov    -0x7feeab04(%eax),%ebx
80106ebb:	8d 53 ff             	lea    -0x1(%ebx),%edx

      if(!shm_table.shm_pages[i].refcnt)
80106ebe:	85 d2                	test   %edx,%edx
      shm_table.shm_pages[i].refcnt--;
80106ec0:	89 90 fc 54 11 80    	mov    %edx,-0x7feeab04(%eax)
      if(!shm_table.shm_pages[i].refcnt)
80106ec6:	75 14                	jne    80106edc <shm_close+0x5c>
      {
        shm_table.shm_pages[i].frame=0;
80106ec8:	c7 80 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%eax)
80106ecf:	00 00 00 
        shm_table.shm_pages[i].id = 0;
80106ed2:	c7 80 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%eax)
80106ed9:	00 00 00 
      }
  ...
  release(&(shm_table.lock));
80106edc:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ee3:	e8 58 d3 ff ff       	call   80104240 <release>
